...
/**
 * Trennstellenfenster für Neuberechnung
 */

public class FrameBerechnungNeu extends Dialog implements ActionListener {
     ...
     */
    public FrameBerechnungNeu(Frame f1){
        //Layout
        super(f1, "Neue Trennstelle", true);
        ...
        //Wenn es bereits einen Eintrag gibt sollen Name und Auftragsnummer übernommen werden
        if(Trennen.getLength() > 0){
            auftragsnummer.setText(Trennen.getTrennstelle(0).getAuftragsnummer());
            name.setText(Trennen.getTrennstelle(0).getNamen());
        }
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource() == btnBerechne){
            try{
                ...
                //Speichern und Schliessen enablen
        ...
        if(e.getSource() == btnSpeichern){
            Trennen.safeTrennstelle(new Kabelwerte(sAuftragsnummer, sDatum, sName, innenaussen, ad1ad2, trennstelle, kabellaengei, ad1i, ad2i, ausseni, inneni, kommentarfeld.getText()));
            JFrameHaupt.setList(sDatum, sAuftragsnummer, kabellaengei, trennstelle);
            dispose();
            setVisible(false);
        }
        repaint();
